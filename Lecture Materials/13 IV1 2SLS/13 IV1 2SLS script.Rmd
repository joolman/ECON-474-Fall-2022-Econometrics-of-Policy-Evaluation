---
title: "13 IV1 Two-Stage Least Squares"
...
hiv = read_dta('C:/Users/johnj/Dropbox/Julian/Academia/UIUC/Semester 11 Fall 2022/ECON474/Data/Thorton 2008 replication files/nonparametricvct.dta')

hiv = hiv %>%
  filter(followupsurvey == 1)
```
...
```{r tab 6}
fit6_1 = feols(got ~ any*male*hiv2004 + 
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 + age + I(age^2) + simaverage + rumphi, 
               data = hiv, subset = hiv$hadsex12 == 1, cluster = 'villnum')

fit6_2 = feols(got_hiv ~ any*male*hiv2004 + 
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 + age + I(age^2) + simaverage + rumphi, 
               data = hiv, subset = hiv$hadsex12 == 1, cluster = 'villnum')

etable(fit6_1, fit6_2,
       fitstat = c('n', "r2", "f"))
```
...
fit6_no_clust = feols(got ~ any*male*hiv2004 + 
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 + age + I(age^2) + simaverage + rumphi, 
               data = hiv, subset = hiv$hadsex12 == 1)

fitstat(fit6_no_clust, 'f')
```
Yikes! 
...
```{r tab6 lm}
fit_lm = lm(got ~ any*male*hiv2004 + 
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 + age + I(age^2) + simaverage + rumphi, 
               data = hiv, subset = hiv$hadsex12 == 1) 
summary(fit_lm)$fstatistic
```
...
fit7_4 = feols(numcond ~  hiv2004 + male + age + I(age^2) + simaverage + rumphi |
                 got + got_hiv ~  
                 any*male*hiv2004 +
                 tinc*male*hiv2004 + I(tinc^2)*male*hiv2004 +
                 distvct*male*hiv2004 + I(distvct^2)*male*hiv2004 -
                 male:hiv2004 - male - hiv2004,
               data = hiv,
               subset = hiv$hadsex12 == 1,
               cluster = 'villnum')
fit7_4
...
```{r tab 6 col 4 just identified}
 feols(numcond ~  hiv2004 + male + age + I(age^2) + simaverage + rumphi |
                 got + got_hiv ~ any + distvct,
               data = hiv,
               subset = hiv$hadsex12 == 1,
               cluster = 'villnum')
```
...
feols(numcond ~  hiv2004 + male + age + I(age^2) + simaverage + rumphi |
                 got + got_hiv ~ any + distvct + tinc + any:hiv2004,
               data = hiv,
               subset = hiv$hadsex12 == 1,
               cluster = 'villnum')
